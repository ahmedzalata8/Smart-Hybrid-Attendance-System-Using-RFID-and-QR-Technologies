...
export default function SessionDetail() {
  ...
  if (!session) return <div className="page"><p className="text-muted">Loading...</p></div>;
    ...
    <div className="page">
      <div className="page-header flex-between">
        ...
        <div className="flex gap-4">
          <Link to={`/lecturer/twin/${id}`} className="btn btn-secondary">Seat Map</Link>
          <Link to={`/lecturer/sessions/${id}/report`} className="btn btn-secondary">View Report</Link>
          {isActive && (
