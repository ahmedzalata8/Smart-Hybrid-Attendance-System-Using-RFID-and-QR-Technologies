...
from app.routers import auth, sessions, attendance, dashboard, reader, admin, rfid_scan
...
app.include_router(rfid_scan.router, prefix="/api/rfid-scan", tags=["RFID Scan"])
